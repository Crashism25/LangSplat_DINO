...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default=None,
                    help='Output directory for compressed features (default: dataset_path/language_features_dim{N})')
    ...
    # Use custom output_dir if provided, otherwise default to language_features_dim{N}
    if args.output_dir is not None:
        output_dir = args.output_dir
    else:
        output_dim = encoder_hidden_dims[-1]  # Last encoder dim is the bottleneck
        output_dir = f"{dataset_path}/language_features_dim{output_dim}"
